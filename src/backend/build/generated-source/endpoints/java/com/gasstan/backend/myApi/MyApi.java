 ...
 * on 2015-12-02 at 01:55:58 UTC 
 * Modify at your own risk.
 */

package com.gasstan.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://egluapp.appspot.com/_ah/api/";
  ...
  public class Login extends MyApiRequest<com.gasstan.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "login/{email}/{password}";
    ...
    protected Login(java.lang.String email, java.lang.String password) {
      super(MyApi.this, "POST", REST_PATH, null, com.gasstan.backend.myApi.model.MyBean.class);
   ...
   * @return the request
   */
  public Register register(java.lang.String email, java.lang.String password) throws java.io.IOException {
    Register result = new Register(email, password);
    initialize(result);
    return result;
  }

  public class Register extends MyApiRequest<com.gasstan.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "register/{email}/{password}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String email, java.lang.String password) {
      super(MyApi.this, "POST", REST_PATH, null, com.gasstan.backend.myApi.model.MyBean.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
      this.password = com.google.api.client.util.Preconditions.checkNotNull(password, "Required parameter password must be specified.");
    }
